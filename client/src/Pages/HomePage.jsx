...
const HomePage = () => {
  ...
  return (
    <div className='home-page' style={{background:palette.background.default}}>
      <h1 className='home-title' style={{color:palette.primary.main}}>SILO</h1>
      <p className='home-description pb-7' style={{color:palette.primary.sub}}>The Truth Will Surface</p>
      <Button variant='contained' onClick={() => dispatch(setMode())}>Dark</Button>
